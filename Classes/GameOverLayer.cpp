...
bool GameOverLayer::init()
{
	...
	do
	{
		...
		MenuItemSprite* pBackItem = MenuItemSprite::create(normalBackToGame, pressedBackToGame, NULL, this, menu_selector(GameOverLayer::menuBackCallback));
		pBackItem->setPosition(Vec2(winSize.width - normalBackToGame->getContentSize().width / 2 - 10, normalBackToGame->getContentSize().height / 2 + 10));
		Menu *menuPause = Menu::create(pBackItem, NULL);
